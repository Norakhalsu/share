...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/contract/accept-contract/{contract_id}").hasAuthority("FARM")
                ...
                .requestMatchers("/api/v1/plant/find-plant-by-id/{plant_id}").permitAll()
                .requestMatchers("/api/v1/plant/find-plant-by-type/{farm_id}/{type}").permitAll()
                ...
                .requestMatchers("/api/v1/order-plant/update-order-plant/").hasAnyAuthority("COMPANY","CUSTOMER")
                ...
                .requestMatchers("/api/v1/order-plant/update-status-order-plant/").hasAuthority("FARM")
                ...
                .requestMatchers("/api/v1/order-plant/comment/{comment}").hasAnyAuthority("COMPANY","CUSTOMER")
                ...
                .requestMatchers("/api/v1/order-farmer/update-order-farmer/").hasAnyAuthority("COMPANY","CUSTOMER")
                ...
                .requestMatchers("/api/v1/order-farmer/update-status-order-Farmer/").hasAuthority("FARMER")
                ...
                .requestMatchers("/api/v1/order-guidance/update-order-guidance/").hasAnyAuthority("COMPANY","CUSTOMER")
                ...
                .requestMatchers("/api/v1/order-guidance/update-status-order-Guidance/").hasAuthority("SPECIALIST")
